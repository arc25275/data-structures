...
# Assignment: Assignment 3 - Linked List
# Due Date: 2/12/2024
# Description: Creating a linked list data structure
...
class LinkedList:
    ...
    def insert_back(self, value: object) -> None:
        """Insert a node at the last location in the list"""
        node = self._head
        while node.next:
            node = node.next
    ...
    def remove_at_index(self, index: int) -> None:
        ...
        old_node = node
        next_node = node.next
        old_node.next = next_node.next

    def remove(self, value: object) -> bool:
        """Remove the first node that contains the value provided"""
        i = 0
        node = self._head.next
        # Start at index 0
        while node:
    ...
    def count(self, value: object) -> int:
        """Counts the amount of times that the value is in the list"""
        count = 0
        node = self._head
        while node:
            if node.value == value:
    ...
    def slice(self, start_index: int, size: int) -> "LinkedList":
        """Returns a new list from start_index to start_index + size"""
